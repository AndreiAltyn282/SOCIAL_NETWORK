...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-y9u+686^#i1&$%h+rh&(yd%=h9*^1qm_!n=dfpewf!wq1u4_nz')
...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv('DB_USER', 'social_user'),
...
# Настройки CORS (для React) — ДОБАВЛЕНЫ ПОРТЫ 3000 И 3001
