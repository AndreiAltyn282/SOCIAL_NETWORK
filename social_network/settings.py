...
SECRET_KEY = 'django-insecure-y9u+686^#i1&$%h+rh&(yd%=h9*^1qm_!n=dfpewf!wq1u4_nz'
...
INSTALLED_APPS = [
    'daphne',  # <-- ДЛЯ WEBSOCKET (ДОЛЖЕН БЫТЬ В САМОМ НАЧАЛЕ!)
    ...
    'ai',
    'core',
    'groups',  # <-- ДОБАВЛЕНО ПРИЛОЖЕНИЕ GROUPS!
]
